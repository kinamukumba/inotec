...
//CONTAR BLOG
$sqlContact = "SELECT COUNT(*) AS total_cursos FROM contact";
$stmtContact = $pdo->prepare($sqlContact);
$stmtContact->execute();
$resultadoBolg = $stmtContact->fetch(PDO::FETCH_ASSOC);
        ...
        <main class="main-dash start">
            <aside class="aside-nav">
                <nav class="aside-nav-item">
                    ...
                    <li class="itens i"><i class="fa fa-commenting" aria-hidden="true"></i>Messagem<i
            ...
            <div class="main-container">
                ...
                <section class="tables-step">
                    <h1>Usuários que contactaram a INOTEC</h1>
                    <table class="table-controle">
                        ...
                        <tbody>
                            <?php
                                $select_all_user = $pdo->query("SELECT * FROM contact")->fetchAll();
