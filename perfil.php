        ...
        <main class="main-dash start">
            <aside class="aside-nav">
                <nav class="aside-nav-item">
                    ...
                    <li class="itens"><i class="fa fa-user-circle" aria-hidden="true"></i>Perfil<i
            ...
            <div class="main-container">
                <section class="container-profile">
                    <div class="data-perfil">
                        <div class="img">
                            <img src="./assets/img/ilustrate/perfil-removebg-preview.png"
                                alt="">
                        </div>
                        <section class="info-perfil">
                            <span class="info-top-perfil">
                                <p class="perfil-name"><?php echo htmlspecialchars($user_name) . ' ' . htmlspecialchars($user_apelido); ?></p>
                            ...
                            <span class="info-top-perfil">
                               <p>00 Curso(s)</p>
                               <p>00 Notificações(s)</p>
                            </span>
                            <span class="info-top-perfil">
                                <p>Telefone: <?php echo htmlspecialchars($user_telefone);?></p>
                ...
                <section class="tables-step profile">
